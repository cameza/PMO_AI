...
export const getLaunchCadenceData = () => {
  ...
  return [
    ...
    { month: 'Sep', count: 1, isCurrent: false },
    { month: 'Oct', count: 2, isCurrent: true },
    { month: 'Nov', count: 1, isCurrent: false },
    { month: 'Dec', count: 0, isCurrent: false },
    { month: 'Jan', count: 1, isCurrent: false },
  ];
};
