...
export default function ProgramDetailPage() {
    ...
    useEffect(() => {
        ...
        async function loadProgram() {
            ...
            try {
                setIsLoading(true);
                const [programData, objectivesData, ds] = await Promise.all([
        ...
        <div className="bg-surface rounded-xl border border-white/10 p-5 hover:border-white/20 transition-all group">
            <div className="flex justify-between items-start gap-4">
                ...
                <div className="flex items-center gap-2 shrink-0">
                    <span className={`px-2 py-0.5 rounded text-[10px] font-bold uppercase ${riskSeverityColors[risk.severity as keyof typeof riskSeverityColors]}`}>
